namespace torsani.giacomo._4i.LibSlotMachine
{
    public class SlotMachine
    {
        ...
        */
        public char let1 { get; set; }
        public char let2 { get; set; }
        public char let3 { get; set; }
        ...
        public void Blocca()
        {
            Console.Write("Inserisci le lettere che vuoi tenere (es. ABC): ");
            string keepLetters = Console.ReadLine().ToUpper();
            if (!keepLetters.Contains(let1))
            {
                let1 = lettere[r.Next(21)];
            }
            if (!keepLetters.Contains(let2))
            {
                let2 = lettere[r.Next(21)];
            }
            if (!keepLetters.Contains(let3))
            {
                let3 = lettere[r.Next(21)];
            }
            Controllo();
